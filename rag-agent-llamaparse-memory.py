...
response2 = agent.chat('How much exactly was allocated to a tax credit to promote investment in green technologies in the 2023 Canadian federal budget?')

print(response2)

response2 = agent.chat("How much was allocated to implement a means-tested dental care program in the 2023 Canadian federal budget?")

print(response2)

response2 = agent.chat("How much was the total of those two allocations added togeter? Use a tool to answer any questions?")
